/**
 * \file dcs/testbed/application_managers.hpp
 *
 * \brief Forward declarations for currently implemented application managers.
 *
...
#ifndef DCS_TESTBED_APPLICATION_MANAGERS_HPP
