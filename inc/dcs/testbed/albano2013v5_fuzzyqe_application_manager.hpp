/**
 * \file dcs/testbed/albano2013v5_fuzzyqe_application_manager.hpp
 *
...
#ifndef DCS_TESTBED_ALBANO2013V5_FUZZYQE_APPLICATION_MANAGER_HPP
#define DCS_TESTBED_ALBANO2013V5_FUZZYQE_APPLICATION_MANAGER_HPP
...
class albano2013v5_fuzzyqe_application_manager: public base_application_manager<TraitsT>
{
	...
	public: albano2013v5_fuzzyqe_application_manager()
	: beta_(0.9),
	...
	private: void init()
	{
		...
		p_iv->setRange(-1, 1);
		p_iv->addTerm(new fl::Ramp("LOW", 0.10, -0.40));
		p_iv->addTerm(new fl::Triangle("FINE", -0.10, 0.10, 0.30));
		p_iv->addTerm(new fl::Ramp("HIGH", 0.10, 0.65));
		p_fuzzy_eng_->addInputVariable(p_iv);
...
}; // albano2013v5_fuzzyqe_application_manager

template <typename T>
const ::std::string albano2013v5_fuzzyqe_application_manager<T>::rgain_fuzzy_var_name = "Rgain";

template <typename T>
const ::std::string albano2013v5_fuzzyqe_application_manager<T>::cres_fuzzy_var_name = "Cres";

template <typename T>
const ::std::string albano2013v5_fuzzyqe_application_manager<T>::deltac_fuzzy_var_name = "DeltaC";

}} // Namespace dcs::testbed

#endif // DCS_TESTBED_ALBANO2013V5_FUZZYQE_APPLICATION_MANAGER_HPP
