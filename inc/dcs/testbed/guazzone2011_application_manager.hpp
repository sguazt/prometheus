/**
 * \file dcs/testbed/guazzone2011_application_manager.hpp
 *
 * \brief Application manager based on the work proposed i
 *  (Guazzone et al., 2011)
 *
...
#ifndef DCS_TESTBED_GUAZZONE2011_APPLICATION_MANAGER_HPP
#define DCS_TESTBED_GUAZZONE2011_APPLICATION_MANAGER_HPP
...
class guazzone2011_application_manager: public base_application_manager<TraitsT>
{
	...
	public: guazzone2011_application_manager()
	: nx_(0),
	  nu_(0),
	  ny_(0),
	  x_offset_(0),
...
}; // guazzone2011_application_manager
...
#endif // DCS_TESTBED_GUAZZONE2011_APPLICATION_MANAGER_HPP
