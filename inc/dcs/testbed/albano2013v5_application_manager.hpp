/**
 * \file dcs/testbed/albano2013v5_application_manager.hpp
 *
...
#ifndef DCS_TESTBED_ALBANO2013V5_APPLICATION_MANAGER_HPP
#define DCS_TESTBED_ALBANO2013V5_APPLICATION_MANAGER_HPP
...
class albano2013v5_application_manager: public base_application_manager<TraitsT>
{
	...
	public: albano2013v5_application_manager()
	: beta_(0.9),
...
}; // albano2013v5_application_manager

template <typename T>
const ::std::string albano2013v5_application_manager<T>::rgain_fuzzy_var_name = "Rgain";

template <typename T>
const ::std::string albano2013v5_application_manager<T>::cres_fuzzy_var_name = "Cres";

template <typename T>
const ::std::string albano2013v5_application_manager<T>::deltac_fuzzy_var_name = "DeltaC";

}} // Namespace dcs::testbed

#endif // DCS_TESTBED_ALBANO2013V5_APPLICATION_MANAGER_HPP
